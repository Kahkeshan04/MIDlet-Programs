//18. Write a program to design and implement Image Slide show on MIDlet. 
...
public class ImageSlideShow extends MIDlet implements CommandListener {
	...
	public ImageSlideShow(){
		...
		try{
			image1=Image.createImage("/1.png"); image2=Image.createImage("/2.png");
		...
		slide1.setCommandListener(this); slide2.setCommandListener(this);
...
class ThreadRunner implements Runnable{
	...
	public ThreadRunner(Display display, Form slide1,Form slide2,Form slide3){
		...
		this.slide1=slide1;
		this.slide2=slide2; this.slide3=slide3;
	}
	public void run()
	{
		while(true) {
