//5. Write a program to implement LogIn<Form> on MIDlet. 
...
public class LoginExample extends MIDlet implements CommandListener{
	...
	public LoginExample() {
		...
		try{
			...
			imge = Image.createImage("/failed.png");
			img2 = Image.createImage("/Congratulations.png");
		}catch(Exception e){
	...
	public void validateUser(String name, String password) {
		if (name.equals("Kahkeshan-01") && password.equals("Kahkeshan")) {
			showMsg();
		} else {
			tryAgain();
		}
